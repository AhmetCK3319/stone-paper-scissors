...
while True:
    ...
    secimler={ "Taş":0,"tas":0,"TAS":0,"TAŞ":0,"Tas":0,"taş":0,
                "kagit":1,"KAGIT":1,"KAĞIT":1,"Kagit":1,"kağit":1,"kağit":1,
    ...
    #kazanma durumlari belirtiliyor
    if usersecim==bilsecim:
        ...
        print("kaybettiniz")
        bilscore+=1        
    print(secenek [bilsecim], "= bilgisayar puani :",bilscore)
    print(secenek [usersecim],"= sizin puaniniz :",userscore)
